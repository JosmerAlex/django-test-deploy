...
class SolicSoporteListView(LoginRequiredMixin, FormView):
...
class SolicSoporteCreateView(LoginRequiredMixin, CreateView):
    model = SolicSoporte
...
class SolicSoporteUpdateView(LoginRequiredMixin, UpdateView):
    model = SolicSoporte
    form_class = FormSolicSoporte
    template_name = 'servicio_tec/create.html'
