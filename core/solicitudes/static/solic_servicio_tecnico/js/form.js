            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, row){
                        return '<a rel="deleteProd" class="btn btn-rounded btn-danger btn-xs"><i class="fas fa-trash-alt"></i></a>'
                    }
                },
                {
                    targets: [-3],
                ...
                },      
                {
                    ...
                    orderable: false,
                    render: function(data, type, row){
                        return '<input type="text" class="form-control form-control-sm input-flat" name="diagnostico" style="text-align: center; font-size: 11px; padding-left:4px; padding-right:4px; height: 24px;" autocomplete="off" placeholder="Ingrese un breve diagnóstico" value="' + row.diagnostico + '">'
                    }
                }
            ],
...
$(function(){
    ...
    $('#tblSolicSupp tbody').on('click', 'a[rel="deleteProd"]', function () {
        var tr = detailSupport.cell($(this).closest('td, li')).index();
